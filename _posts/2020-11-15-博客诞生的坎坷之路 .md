...
![](D:\Cloud-git\img\1.1.bmp)

点击fork，fork完成后该仓库就拉到我们自己页面下了，然后我们来进行相应的改动

![](D:\Cloud-git\img\1.2.bmp)
...
![](D:\Cloud-git\img\1.3.bmp)

![](D:\Cloud-git\img\1.4.bmp)
...
由于这个Key也不是用于军事目的，所以也无需设置密码,所以一路回车就好,![](D:\Cloud-git\img\1.5.bmp)
...
![](D:\Cloud-git\img\1.6.bmp)

下一步，选择一个本地路径，在路径中右键，给git bash here

![](D:\Cloud-git\img\1.7.bmp)
